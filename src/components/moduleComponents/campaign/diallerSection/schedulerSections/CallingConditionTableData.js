...
import PriorityDropdown from "../../../../../../../../newChatHistory/Chat-History-Dashboard/src/components/ui-kit/priorityDropdown/PriorityDropdown";
import SameDayComponent from "../../../../../../../../newChatHistory/Chat-History-Dashboard/src/components/ui-kit/samedayComponent/SameDayComponent";
import "./CallingConditionTableData.css";
import downArrow from "../../../assets/priorityDropdownIcon.svg";
...
function CallingConditionTableData(props) {
  ...
  const prioratizeData=(callingData)=>{
    if(callingData?.includes("Due Date")){
        ...
        props.setSelectedCallingData(callingData)
        // props.setCallingCondition(setPriorityOrder)
    }
  }
